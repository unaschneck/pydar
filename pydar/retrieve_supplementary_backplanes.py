...
def extractMetadata(isVersionComplete=False):
    ...
    logger.info('Unique Beam Patterns used after filtering: ' +
                str(sbdr_sar['BEM'].unique()))
