...
earth_rad = 6378206.4
geodesic = pyproj.Geod(a=earth_rad,
                       es=0)  # eccentricity = 0 because it's a sphere

fwd_azimuth, back_azimuth, distance = geodesic.inv(boston_lon, boston_lat,
                                                   london_lon, london_lat)

#print(f"bck azimuth: {back_azimuth}\n")
#print(distance/1000)
